    ...
    public class Nienna_WorkGiver_HealingTouch : WorkGiver_Tend
    {
        ...
        public override bool HasJobOnThing(Pawn pawn, Thing t, bool forced = false)
        {
            ...
            if (pawn.story.traits.HasTrait(WizardryDefOf.LotRW_Istari))
            {
                ...
                if (t is Pawn pawn2 && (!this.def.tendToHumanlikesOnly || pawn2.RaceProps.Humanlike) && (!this.def.tendToAnimalsOnly || pawn2.RaceProps.Animal) && WorkGiver_Tend.GoodLayingStatusForTend(pawn2, pawn) && HasHediffInjuries(pawn2) && pawn != pawn2 && pawnAbility.CooldownTicksLeft <= 0)
                {
